...
The lab manual is what you will work from every day in class. You will need to bring a copy of the lab manual (physical or electronic) with you to class every day. To download a PDF copy of the lab manual, click this link: [https://github.com/zief0002/Statistical-Thinking/blob/master/Statistical-Thinking-v4.pdf?raw=true](https://github.com/zief0002/Statistical-Thinking/blob/master/Statistical-Thinking-v4.pdf?raw=true).
