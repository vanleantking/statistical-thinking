...
The data sets used in the lab manual, as well as those used in EPsy 3264 assignments, are available at [https://github.com/zief0002/Statistical-Thinking/archive/master.zip](https://github.com/zief0002/Statistical-Thinking/archive/master.zip). Clicking this link will download a ZIP file to your computer. This file includes all the data sets and the lab manual. Double-click on the ZIP file to view all the materials.
