...
To download a ZIP file to your computer that includes all the data sets and the lab manual, click this link: [https://github.com/zief0002/Statistical-Thinking/archive/master.zip](https://github.com/zief0002/Statistical-Thinking/archive/master.zip). Once the ZIP file has been downloaded to your computer, double-click to unzip it and access the materials.
