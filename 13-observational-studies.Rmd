...
Although you probably won't be able to draw a cause-and-effect inference, observational data can still be analyzed. Observational studies are often precursors to randomized studies&mdash; recall that one criteria of cause is that correlation exists, and observational data is a good for examining correlation.
